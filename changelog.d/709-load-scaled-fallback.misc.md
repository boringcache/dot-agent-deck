...
Reverting the fallback cannot regress macOS relative to its own history: the waits #709 converted were flat, unscaled 2s and 5s ceilings before it, on every platform, and the unscaled child-boot base is 8s. The 6x was never measured to be needed off Linux — #709's starvation was measured on a 16-core Linux box, where the measurement works and the scaling still applies.
